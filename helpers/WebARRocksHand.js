...
var WEBARROCKSHAND = (function () {
  var StereoAudioRecorder = null,
    CanvasRecorder = null,
    isFloat = null,
    isPot = null,
    isLinear = null,
    ...
    attributes = null,
    _shaders = null;
  window.WEBARROCKSHAND = (function () {
    function Yb(a) {
      var b = null,
        d = null,
        e = null,
        ...
        if (null === m) m = na[0];
          ...
          if (g) {
            ...
            if ((v = g.ea !== da[e].ea))
              for (
                n = 0;
                n < ma.switchNNConsecutiveIterations &&
                ((v = g.ea === m[n]), v);
                ++n
              );
            v
              ? ((m = g), ++la.Zc[e], (la.eb[e] = 0))
              : ((m = da[e]), ++la.eb[e]);
          }
        } else if (!g)
          for (
        ...
        var m = null,
          ...
          x = {
            ...
            m: function () {
              c && (aa.m(), A.m(), Ea.m());
              v &&
                (m.removeEventListener("webglcontextlost", v, !1), (v = null));
              c = r = q = n = m = null;
              C.splice(0);
            },
          };
          ...
          n = {
            ...
            A: function () {
              if (!e) {
                ...
                var q = aa.qa();
                b =
                  q && c.DRAW_FRAMEBUFFER ? c.DRAW_FRAMEBUFFER : c.FRAMEBUFFER;
                d =
                  q && c.READ_FRAMEBUFFER ? c.READ_FRAMEBUFFER : c.FRAMEBUFFER;
                e = !0;
              }
            },
            Ph: function () {
            ...
            return {
              ...
              Z: function (g) {
                if (g.isEnabled) {
                  ...
                  g.kg.h(3);
                  for (
                    var m = Math.min(g.gb.length, g.depth), n = 0;
                    n < m;
                    ++n
                  )
                    g.gb[n].Te(4 + n);
            ...
            if (a.video.width.ideal && a.video.height.ideal) {
              ...
              for (q.Ca = void 0; l < m.length; q = { Ca: q.Ca }, ++l) {
                ...
                for (r.va = void 0; v < n.length; r = { va: r.va }, ++v)
                  if (
                    ((r.va = n[v]),
                    q.Ca !== a.video.width.ideal ||
                      r.va !== a.video.height.ideal)
                  ) {
                ...
                Y.Nd(function (g) {
                  g
                    ? (g = g.find(function (m) {
                      ...
                      ? ((a.video.deviceId = { exact: g.deviceId }),
                        e("SUCCESS"))
                              ...
                              for (var c = 0; c < 6; ++c)
                                r.set(c, 0, (0, n.zzs3)(o[0][c], o[0][c])),
                                  r.set(
                                    c,
                                    1,
                                    2 * (0, n.zzs3)(o[0][c], o[1][c])
                                  ),
                                  r.set(c, 2, (0, n.zzs3)(o[1][c], o[1][c])),
                                  r.set(
                                    c,
                                    3,
                                    2 * (0, n.zzs3)(o[0][c], o[2][c])
                                  ),
                                  r.set(
                                    c,
                                    4,
                                    2 * (0, n.zzs3)(o[1][c], o[2][c])
                                  ),
                                  r.set(c, 5, (0, n.zzs3)(o[2][c], o[2][c])),
                                  r.set(
                                    c,
                                    6,
                                    2 * (0, n.zzs3)(o[0][c], o[3][c])
                                  ),
                                  r.set(
                                    c,
                                    7,
                                    2 * (0, n.zzs3)(o[1][c], o[3][c])
                                  ),
                                  r.set(
                                    c,
                                    8,
                                    2 * (0, n.zzs3)(o[2][c], o[3][c])
                                  ),
                              ...
                              [
                                ...
                                },
                                {
                                  ...
                                  value: function () {
                                    ...
                                    for (
                                      var i = new E(this.zzk2, this.zzj2),
                                        a = 0;
                                      a < this.zzk2;
                                      a++
                                    ) {
